    ...
    try {
        ...
        let chat: IChat | undefined = {
            ...
            context: [
                ...
                { role: "system", content: "Твоя задача: поиск соответствующего шаблона на основе текста пользователя. Если шаблон существует, верни номер шаблона. Если шаблон отсутствует, верни null" }
